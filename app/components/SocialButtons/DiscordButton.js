    ...
    >
      <div className={styles.tooltipContainer}>
        ...
        <div className={styles.text}>
          <a href={href} target={href === '#copy' ? '_self' : '_blank'} rel="noopener noreferrer" className={styles.icon} onClick={handleClick}>
            <div className={styles.layer}>
              ...
              <span className={styles.svgContainer}>
                 <svg className={styles.svg} preserveAspectRatio="xMidYMid" xmlns="http://www.w3.org/2000/svg" viewBox="0 -3.117 28 28">
