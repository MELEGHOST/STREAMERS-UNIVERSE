          ...
          <a href={href} target="_blank" rel="noopener noreferrer" className="icon">
            <div className="layer">
              ...
              <span className="svg-container">
                <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32 32" width="100%" height="100%" preserveAspectRatio="xMidYMid meet">
...
const StyledWrapper = styled.div`
 ...
 .layer span.svg-container {
  ...
  .layer span.svg-container svg {
      /* Размеры SVG уже 100%, можно убрать отсюда */
      /* width: 60%; */ 
      /* height: 60%; */ 
  }
  ...
  /* Убедимся, что SVG остается видимым при ховере */
  .tooltip-container:hover .layer span.svg-container {
      background: transparent;
      border: none;
      box-shadow: none;
  }
