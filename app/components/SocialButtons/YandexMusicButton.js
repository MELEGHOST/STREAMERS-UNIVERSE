        ...
        <div className={styles.text}> 
          <a href={href} target="_blank" rel="noopener noreferrer" className={styles.icon}>
            <div className={styles.layer}>
              ...
              <span style={{ background: '#212121' }} />
              <span style={{ background: '#212121' }} />
              <span className={styles.svgContainer} style={{ background: '#212121' }}>
                <svg className={styles.svg} version="1.1" id="Слой_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="8 8 60 60" xmlSpace="preserve">
                  <path id="star" d="M39.2,20.019l-0.129-0.607l-5.097-0.892l2.968-4.021
