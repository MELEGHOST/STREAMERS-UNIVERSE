  ...
  return (
    <div className={styles.widgetContainer}>
      <h2 className={styles.widgetTitle}>
        {t('statistics.widget.title', { defaultValue: 'Статистика' })}
      </h2>
      <div className={styles.statsGrid}>
        <div className={styles.statItem}>
          <FaUserFriends className={styles.statIcon} />
          <span className={styles.statValue}>
            {formatNumber(stats?.[0]?.value ?? source?.followers_count)}
          </span>
        ...
        <div className={styles.statItem}>
          ...
          <span className={styles.statValue}>
            {formatNumber(stats?.[1]?.value ?? source?.view_count)}
          </span>
        ...
        <div className={styles.statItem}>
          ...
          <span className={styles.statValue}>
            {source?.broadcaster_type || 'N/A'}
          </span>
          <span className={styles.statLabel}>
            {t('profile_page.broadcasterLabel', { defaultValue: 'Статус' })}
          </span>
        </div>
        <div className={styles.statItem}>
          ...
          <span className={styles.statLabel}>
            {t('profile_page.onTwitchSince', { defaultValue: 'На Twitch с' })}
          </span>
        </div>
      </div>
      ...
      <div className={styles.socialLinksContainer}>
        ...
        {socialLinks.telegram && (
          <TelegramButton value={socialLinks.telegram} />
        )}
        ...
        {socialLinks.yandex_music && (
          <YandexMusicButton value={socialLinks.yandex_music} />
        )}
      </div>
    </div>
  );
