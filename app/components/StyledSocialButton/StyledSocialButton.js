...
const platformData = {
  ...
  default: {
    ...
    svgPath:
      'M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 22c-5.514 0-10-4.486-10-10s4.486-10 10-10 10 4.486 10 10-4.486 10-10 10zm5-10h-4v-4h-2v4h-4v2h4v4h2v-4h4v-2z', // Пример иконки ссылки
    viewBox: '0 0 24 24',
  },
};
// --------------------------------
...
const StyledSocialButton = ({ platform, url }) => {
  ...
  const isLinkActive =
    platform !== 'discord' ||
    (typeof finalUrl === 'string' && finalUrl.startsWith('http'));
