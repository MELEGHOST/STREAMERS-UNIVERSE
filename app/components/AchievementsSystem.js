      ...
      <div className={styles.streamerProgressContainer}>
        ...
        <div className={styles.streamerTips}>
          ...
          {followerCount >= 100 && (
            <div className={styles.unlockedTip}>
              <h4>Разблокированный совет:</h4>
              <p>Настройте начатки и оповещения для стрима</p>
            </div>
          )}
    ...
    <div className={styles.achievementsContainer}>
      ...
      <div className={styles.achievementsList}>
        ...
        {achievements.filter(a => 
          ...
          <p>Вы разблокировали все основные достижения!</p>
        ) : (
          <div className={styles.achievementsGrid}>
            {achievements
              .filter(a => 
        ...
        <div className={styles.achievementsList}>
          ...
          <div className={styles.achievementsGrid}>
            {unlockedAchievements
              .filter(a => a.isSecret)
              .map(achievement => (
                <div key={achievement.id} className={styles.achievementCard + ' ' + styles.secret}>
                  <div className={styles.achievementIcon}>{achievement.icon}</div>
                  <h4>{achievement.title}</h4>
                  <p>{achievement.description}</p>
                  <span className={styles.achievementXp}>+{achievement.xp} XP</span>
      ...
      {/* Скрытая область для активации пасхалки */}
      <div 
