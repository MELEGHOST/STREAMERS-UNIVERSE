  ...
  const fetchReviews = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || 'Failed to fetch reviews for moderation.'
        );
      }
                  ...
                  <td className={styles.actions}>
                    ...
                    >
                      {updatingId === review.id
                        ? t('admin_reviews.approving')
                        : t('admin_reviews.approve')}
                    </button>
                    <button
                    ...
                    >
                      {updatingId === review.id
                        ? t('admin_reviews.rejecting')
                        : t('admin_reviews.reject')}
                    </button>
                  </td>
                </tr>
              ))}
