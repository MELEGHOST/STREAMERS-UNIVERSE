...
export async function PUT(request) {
  ...
  try {
    ...
    console.error(
      '[API /twitch/user/profile] Token verification failed:',
      error
    );
    return NextResponse.json(
  ...
  if (!supabaseUrl || !supabaseServiceKey) {
    console.error(
      '[API /twitch/user/profile] Critical Error: Supabase URL or Service Key is missing!'
    );
    return NextResponse.json(
  ...
  if (profile_widget !== undefined)
    dataToUpdate.profile_widget = profile_widget;
  ...
  console.log(
    `[API /twitch/user/profile] Updating profile for user ${userId} with data:`,
    dataToUpdate
  );
  ...
  try {
    ...
    if (error) {
      console.error(
        `[API /twitch/user/profile] Error updating profile:`,
        error
      );
      return NextResponse.json(
